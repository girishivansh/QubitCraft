...
export function ProbabilityChart({ result }: ProbabilityChartProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-semibold text-slate-800 dark:text-white mb-4">Measurement Outcomes</h3>
              ...
              <div key={state} className="flex flex-col gap-2">
                <div className="flex justify-between items-end">
                  <div className="flex items-center gap-2">
                    <span className="font-mono bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 px-2 py-1 rounded text-sm font-semibold border border-slate-200 dark:border-slate-700">
                      |{state}⟩
                    </span>
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <span className="text-[10px] text-slate-400 dark:text-slate-500">prob: {prob.toFixed(4)}</span>
                  </div>
                </div>
                <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden w-full border border-slate-200 dark:border-slate-700">
                  <div 
